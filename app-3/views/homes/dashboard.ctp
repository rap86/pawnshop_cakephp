...
<p class="w3-border-bottom">Under Auction Takeout</p>
<div class="row">
	<div class="col-lg-3 col-md-3">
		<div class="panel w3-gray">
			<div class="panel-heading">
				<div class="row">
					<div class="col-xs-3">
						<i class="fa fa-tasks fa-3x"></i>
					...
					<div class="col-xs-9 text-right">
						<div class="w3-xlarge"><?php echo $status_count[0][0]['book_one_item_to']; ?> <br /> <?php echo number_format($status_count[0][0]['book_one_amount_to'], 0); ?></div>
						<div>Count | Amount</div>
					</div>
				</div>
			</div>
			<a href="#" class="w3-text-black">
				<div class="panel-footer  w3-hover-gray">
					<span class="pull-left">Book 1</span>
					<span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
					<div class="clearfix"></div>
				</div>
		...
		<div class="panel w3-gray">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="w3-xlarge"><?php echo $status_count[0][0]['book_two_item_to']; ?> <br /> <?php echo number_format($status_count[0][0]['book_two_amount_to'], 0); ?></div>
						<div>Count | Amount</div>
					</div>
				</div>
			</div>
		...
		<div class="panel w3-gray">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="w3-xlarge"><?php echo $status_count[0][0]['book_three_item_to']; ?> <br /> <?php echo number_format($status_count[0][0]['book_three_amount_to'], 0); ?></div>
						<div>Count | Amount</div>
					</div>
				</div>
			</div>
			...
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="w3-xlarge">
							<?php
								echo $status_count[0][0]['book_one_item_to'] + $status_count[0][0]['book_two_item_to'] + $status_count[0][0]['book_three_item_to']; 
							?> 
							<br />
							<?php 
								echo number_format($status_count[0][0]['book_one_amount_to'] + $status_count[0][0]['book_two_amount_to'] + $status_count[0][0]['book_three_amount_to'], 0); 
							?>
						</div>
						<div>Count | Amount</div>
					</div>
