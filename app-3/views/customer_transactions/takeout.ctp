<?php 
	...
	foreach($datas as $key => $value)
	{
		...
		if($value['TransactionInterestPayment'][count($value['TransactionInterestPayment']) -1 ]['status'] == 'unpaid')
		{
			$dueDate_b1 	= date($value['TransactionInterestPayment'][count($value['TransactionInterestPayment']) -1 ]['payment_starting_date']);
			...
			$value['TransactionInterestPayment'][ count($value['TransactionInterestPayment']) -1 ]['date_diff'] = 'Y'.$this->yearPayment1.'-'.'M'.$this->monthPayment1.'-'.'D'.$this->dayPayment1;
		}
...
<div class="row">
	<div class="col-lg-12">
		<h3 style="border-bottom:1px solid #e5e5cc;" class="w3-gray w3-padding w3-border w3-border-gray">Under Auction Takeout</h3>
					...
					<tbody>
						  <?php foreach($pawn_book1 as $keyua1 => $valueua1): ?>
							...
							<tr>
								...
								<td>
									<?php echo $valueua1['TransactionInterestPayment'][count($valueua1['TransactionInterestPayment']) -1 ]['payment_starting_date']; ?>
								</td>
								<td>
									<?php echo $valueua1['TransactionInterestPayment'][count($valueua1['TransactionInterestPayment']) -1 ]['date_diff']; ?>
								</td>
								<td>
					...
					<tbody>
						  <?php foreach($pawn_book2 as $keyua2 => $valueua2): ?>
							...
							<tr>
								...
								<td>
									<?php echo $valueua2['TransactionInterestPayment'][count($valueua2['TransactionInterestPayment']) -1 ]['payment_starting_date']; ?>
								</td>
								<td>
									<?php echo $valueua2['TransactionInterestPayment'][count($valueua2['TransactionInterestPayment']) -1 ]['date_diff']; ?>
								</td>
								<td>
					...
					<tbody>
						  <?php foreach($pawn_book3 as $keyua3 => $valueua3): ?>
							...
							<tr>
								...
								<td>
									<?php echo $valueua3['TransactionInterestPayment'][count($valueua3['TransactionInterestPayment']) -1 ]['payment_starting_date']; ?>
								</td>
								<td>
									<?php echo $valueua3['TransactionInterestPayment'][count($valueua3['TransactionInterestPayment']) -1 ]['date_diff']; ?>
								</td>
								<td>
					...
					<tbody>
						  <?php foreach($semiua as $keySemi => $valueSemi): ?>
							...
							<tr>
								...
								<td>
									<?php echo $valueSemi['TransactionInterestPayment'][count($valueSemi['TransactionInterestPayment']) -1 ]['payment_starting_date']; ?>
								</td>
								<td>
									<?php echo $valueSemi['TransactionInterestPayment'][count($valueSemi['TransactionInterestPayment']) -1 ]['date_diff']; ?>
								</td>
								<td>
