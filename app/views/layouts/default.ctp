                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
									<a href="/cash_books/list_deposit">List of Deposit</a>
								</li>
								<li>
									<a href="/cash_books/list_withdrawal">List of Withdrawal</a>
								</li>
								<li>
									<a href="/cash_books/list_expenses">Add / List Expenses</a>
								</li>
								<li>
									<a href="/cash_books/list_cashtype">List Cash in/Cash out</a>
								</li>
								<li>
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
								<li>
									<a href="/cash_books/add_deposit">Add Deposit</a>
								</li>
								<li>
									<a href="/cash_books/add_withdrawal">Add Withdrawal</a>
								</li>
								<li>
									<a href="/cash_books/add_cashtype">Add Cash in/Cash out</a>
								</li>
                               <li>
