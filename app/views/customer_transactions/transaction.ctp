											...
											if($keyValue['book_id'] == 3)
											{
												...
												*/
												...
												if($keyValue['deduct_first_month'] == 'no') {
													...
													$redeemgrand_charge_amount = ($payment_amount + $keyValue['net_amount_duplicate']) - ((($first_month_interest_book3 + $service_charge + $keyValue['doc_stamp_interest']) / 100) * $keyValue['net_amount_duplicate']);
												}
