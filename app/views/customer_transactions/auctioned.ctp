...
<div class="row">
	<div class="col-lg-12">
		<h3 style="border-bottom:1px solid #e5e5cc;" class="w3-pale-yellow w3-padding w3-border w3-border-amber">Auctioned</h3>
		<!-- Nav tabs -->
		<!--ul class="nav nav-tabs" id="myTab">
			...
			<li>
				<a href="/customer_transactions/redeemed">Redeemed</a>
			</li>
			<li class="active">
				<a href="#">Auctioned</a>
			</li>
	...
	<div class="col-lg-12">
		<?php echo $this->Form->create('CustomerTransaction', array('action'=>'auctioned')); ?>
					...
					<tbody>
						  <?php foreach($datas as $key => $value): ?>
							...
							<tr>
								...
								<td>
									<?php echo date('M j, Y g:i:A', strtotime($value['TransactionSoldItem']['date_sold'].' '.$value['TransactionSoldItem']['time_sold'])); ?>
								</td>
								<td>
