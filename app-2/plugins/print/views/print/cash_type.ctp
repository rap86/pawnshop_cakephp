<html>
	...
	<body>
		<htmlpageheader name="myHTMLHeader1">
			...
			<p style="font-family:arial;">Cash type: <b><?php echo $status; ?></b><br />Date Converage From: <?php echo date('M j, Y', strtotime($date['from'])); ?>  To: <?php echo date('M j, Y', strtotime($date['to'])); ?></p>
