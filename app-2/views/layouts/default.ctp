            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
							<a href="/customer_transactions/pawn" class="w3-red"><i class="fa fa-money fa-fw"></i> Pawned</a>
						</li>
						<li>
							<a href="/customer_transactions/under_auction" class="w3-green"><i class="fa fa-money fa-fw"></i> Under Auction</a>
						</li>
						<li>
							<a href="/customer_transactions/redeemed" class="w3-blue"><i class="fa fa-money fa-fw"></i> Redeemed</a>
						</li>
						<li>
							<a href="/customer_transactions/auctioned" class="w3-amber"><i class="fa fa-money fa-fw"></i> Auctioned</a>
						</li>
                        <li>
						...
						<li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Admin Options<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                               <li>
...
$(document).ready(function() {
	...
	$(document).bind("contextmenu",function(e){
		...
		alertSwal('Right click is disabled!');
