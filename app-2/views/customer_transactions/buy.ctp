...
<div class="row">
	<div class="col-lg-12">
		<h3 style="border-bottom:1px solid #e5e5cc;" class="w3-pale-green w3-padding w3-border w3-border-green">Buy these item</h3>
		<!-- Nav tabs -->
					...
					<tbody>
						  <?php foreach($pawn_book1 as $keyua1 => $valueua1): ?>
							...
							<tr>
								...
								<td>
									<a data-net-amount-duplicate="<?php echo $valueua1['CustomerTransaction']['net_amount_duplicate']; ?>" data-customer-transactionid="<?php echo $valueua1['CustomerTransaction']['id']; ?>" data-customerid="<?php echo $valueua1['Customer']['id']; ?>" data-forbir="<?php echo $valueua1['CustomerTransaction']['for_bir']; ?>" data-bookid="<?php echo $valueua1['CustomerTransaction']['book_id']; ?>" data-ptnumber="<?php echo $valueua1['TransactionInterestPayment'][ count($valueua1['TransactionInterestPayment']) -1 ]['pt_number']; ?>" data-auction-price="<?php echo $valueua1['TransactionUnderAuction']['auction_price'];?>" class="w3-button w3-teal w3-round-small" data-toggle="modal" data-target="#myModalBuyItemx" id="buybutton">Buy</a>
					...
					<tbody>
						  <?php foreach($pawn_book2 as $keyua2 => $valueua2): ?>
							...
							<tr>
								...
								<td>
									<a data-net-amount-duplicate="<?php echo $valueua2['CustomerTransaction']['net_amount_duplicate']; ?>" data-customer-transactionid="<?php echo $valueua2['CustomerTransaction']['id']; ?>" data-customerid="<?php echo $valueua2['Customer']['id']; ?>" data-forbir="<?php echo $valueua2['CustomerTransaction']['for_bir']; ?>" data-bookid="<?php echo $valueua2['CustomerTransaction']['book_id']; ?>" data-ptnumber="<?php echo $valueua2['TransactionInterestPayment'][ count($valueua2['TransactionInterestPayment']) -1 ]['pt_number']; ?>" data-auction-price="<?php echo $valueua2['TransactionUnderAuction']['auction_price'];?>" class="w3-button w3-teal w3-round-small" data-toggle="modal" data-target="#myModalBuyItemx" id="buybutton">Buy</a>
					...
					<tbody>
						  <?php foreach($pawn_book3 as $keyua3 => $valueua3): ?>
							...
							<tr>
								...
								<td>
									<a data-net-amount-duplicate="<?php echo $valueua3['CustomerTransaction']['net_amount_duplicate']; ?>" data-customer-transactionid="<?php echo $valueua3['CustomerTransaction']['id']; ?>" data-customerid="<?php echo $valueua3['Customer']['id']; ?>" data-forbir="<?php echo $valueua3['CustomerTransaction']['for_bir']; ?>" data-bookid="<?php echo $valueua3['CustomerTransaction']['book_id']; ?>" data-ptnumber="<?php echo $valueua3['TransactionInterestPayment'][ count($valueua3['TransactionInterestPayment']) -1 ]['pt_number']; ?>" data-auction-price="<?php echo $valueua3['TransactionUnderAuction']['auction_price'];?>" class="w3-button w3-teal w3-round-small" data-toggle="modal" data-target="#myModalBuyItemx" id="buybutton">Buy</a>
	...
	<div class="modal-dialog">
		<form method="post" action="/transaction_sold_items/add">
			<div class="modal-content">
				 ...
				 <input name="data[TransactionSoldItem][customer_id]" id="tcustomer_id" type="hidden">
...
$(document).ready(function() {
	...
	$('a#buybutton').click(function() {
		...
		$('input#tcustomer_id').val( $(this).attr("data-customerid"));
