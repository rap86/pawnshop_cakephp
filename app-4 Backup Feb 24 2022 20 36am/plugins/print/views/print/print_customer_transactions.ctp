...
foreach($transaction_details as $key=>$value)
{
	...
	$details['Customer'] 						= $value['Customer'];
	$details['TransactionInterestPayment'] 		= $value['TransactionInterestPayment'];
	$details['CustomerTransaction'] 			= $value['CustomerTransaction'];
	$details['TransactionPrincipalPayment'] 	= $value['TransactionPrincipalPayment'];
	$details['TransactionRedeemItem']		 	= $value['TransactionRedeemItem'];
	$details['TransactionSoldItem']		 		= $value['TransactionSoldItem'];
	$details['TransactionUnderAuction']		 	= $value['TransactionUnderAuction'];
...
<html>
	...
	<body>
		...
		<?php if(isset($details['TransactionSoldItem']) && !empty($details['TransactionSoldItem'])) { ?>
			...
			<table id="principal_details" style="width:100%; border-collapse:collapse; font-family:arial; margin-bottom:10px;" border="1" cellpadding="5">
				<tr>
					<td colspan="4" style="font-weight:bold; text-align:left;">Sold Item Details</td>
				</tr>
				<tr>
					<td style="width:25%; font-weight:bold;">Sold Price</td>
					<td style="width:25%; font-weight:bold;">Discount</td>
					<td style="width:25%; font-weight:bold;">OR</td>
					<td style="width:25%; font-weight:bold;">Date</td>
				</tr>
				<?php foreach($details['TransactionSoldItem'] as $keySold => $valueSold): ?>
					
					<tr>
						<td><?php echo $valueSold['sold_price']; ?></td>
						<td><?php echo $valueSold['discount']; ?></td>
						<td><?php echo $valueSold['or_number']; ?></td>
						<td><?php echo date('M j, Y g:i A', strtotime($valueSold['date_sold'].' '.$valueSold['time_sold'])); ?></td>
					</tr>
		...
		<?php if(isset($details['TransactionUnderAuction']) && !empty($details['TransactionUnderAuction'])) { ?>
			
			<table id="principal_details" style="width:100%; border-collapse:collapse; font-family:arial; margin-bottom:10px;" border="1" cellpadding="5">
				<tr>
					<td colspan="4" style="font-weight:bold; text-align:left;">Under Auction Details</td>
				</tr>
				<tr>
					<td style="width:35%; font-weight:bold;">Auction Price</td>
					<td style="width:30%; font-weight:bold;">Date</td>
					<td style="width:35%; font-weight:bold;">Details</td>
				</tr>
				<?php foreach($details['TransactionUnderAuction'] as $keyUa=> $valueUa): ?>
					
					<tr>
						<td><?php echo $valueUa['auction_price']; ?></td>
						<td><?php echo date('M j, Y g:i A', strtotime($valueUa['date_auction'].' '.$valueUa['time_auction'])); ?></td>
						<td><?php echo $valueUa['details']; ?></td>
					</tr>
		...
		<?php if(isset($details['TransactionPrincipalPayment']) && !empty($details['TransactionPrincipalPayment'])) { ?>
			...
			<table id="principal_details" style="width:100%; border-collapse:collapse; font-family:arial; margin-bottom:10px;" border="1" cellpadding="5">
				<tr>
					<td colspan="4" style="font-weight:bold; text-align:left;">Principal Payment Details</td>
				</tr>
				<tr>
				...
				<?php foreach($details['TransactionPrincipalPayment'] as $keyPrincipal => $valuePrincipal): ?>
					...
					<tr>
						<td><?php echo $valuePrincipal['id']; ?></td>
		...
		<?php if(isset($details['TransactionRedeemItem']) && !empty($details['TransactionRedeemItem'])) { ?>
			
			<table id="principal_details" style="width:100%; border-collapse:collapse; font-family:arial; margin-bottom:10px;" border="1" cellpadding="5">
				<tr>
					<td colspan="6" style="font-weight:bold; text-align:left;">Redeemed Details</td>
				</tr>
				<tr>
				...
				<?php foreach($details['TransactionRedeemItem'] as $keyRedeem => $valueRedeem): ?>
					
					<tr>
						<td><?php echo date('M j, Y g:i A', strtotime($valueRedeem['date_redeemed'].' '.$valueRedeem['time_redeemed'])); ?></td>
						<td><?php echo $valueRedeem['remaining_principal']; ?></td>
						<td><?php echo $valueRedeem['payment_interest']; ?></td>
						<td><?php echo $valueRedeem['payment_amount']; ?></td>
						<td><?php echo $valueRedeem['service_charge']; ?></td>
						<td><?php echo $valueRedeem['grand_amount']; ?></td>
					</tr>
		...
		<table id="payment_details" style="width:100%; border-collapse:collapse; font-family:arial;" border="1" cellpadding="5">
			<tr>
				<td colspan="6" style="font-weight:bold; text-align:left;">Interest Details</td>
			</tr>
			<tr>
				...
				<td style="width:20%; font-weight:bold;">Due Amount</td>
				<td style="width:20%; font-weight:bold;">Payment</td>
				<td style="width:20%; font-weight:bold;">Payment Date</td>
			</tr>
			
		<?php foreach($details['TransactionInterestPayment'] as $key => $value) { ?>
		
			<tr>
				<td><?php echo $value['pt_number']; ?></td>
				<td><?php echo date('M j, Y', strtotime($value['payment_due_date'])); ?></td>
				<td><?php echo $value['payment_due_interest']; ?> %</td>
				<td><?php echo $value['payment_due_amount']; ?></td>
