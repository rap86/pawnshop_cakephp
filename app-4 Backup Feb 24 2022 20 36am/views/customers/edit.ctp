...
<?php echo $this->Form->create('Customer', array("action"=>"edit", 'class'=>'form-horizontal', 'enctype'=>'multipart/form-data')); ?>
<?php echo $this->Form->hidden('Customer.customer_image', array('class'=>'form-control', 'label'=>false, 'id'=>'patientPhoto')); ?>
<?php echo $this->Form->hidden('id', array('class'=>'form-control', 'label'=>false)); ?>
	
<div class="row">
	<div class="col-lg-12">
		<h3 style="border-bottom:1px solid #e5e5cc;">Edit Customer Details</h3>
		<!-- Nav tabs -->
			...
			<div class="tab-pane fade" id="menu2">
				<div class="col-md-6">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div style="min-height: 344px;" class="w3-container w3-center w3-padding-large" id="results">
							  <img src="<?php echo $this->data['Customer']['image_location']; ?>" alt="Avatar" class="img-thumbnail avatar">
							</div>
						</div>
						<div class="panel-footer">
							<div class="w3-section">
								<input name="data[Customer][image_name]" type="file" class="btn btn-default text-center form-control file-upload btn-block patientImagePreview" id="patientImage">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div style="min-height: 344px;" class="w3-container w3-center w3-padding-large " id="my_camera">
...
<div style="margin-left:10px; display:none;">
	<?php echo $this->Form->submit(__('Submit Information',true), array('class'=>'w3-btn w3-blue-grey w3-round-small', 'style'=>'text-shadow:1px 1px 0 #444;', 'id'=>'submitCustomerDetails')); ?>
...
<div class="row">
	<div class="col-lg-12">
		<div class="w3-container">
			<div>
				<button data-toggle="modal" data-target="#myModalTransactionConfirmation" class="w3-btn w3-blue-grey w3-round-small">Submit Information</button>
				<hr />
			</div>
		</div>
	</div>
	...
	function take_snapshot() {
			...
			Webcam.snap( function(data_uri) {
				...
				Webcam.upload( data_uri, '../customer_image', function(code, text) {
					...
					document.getElementById('results').innerHTML = '<img class="img img-thumbnail" src="'+data_uri+'"/>';
					document.getElementById('patientPhoto').value = imageName; 
...
// $("#datepicker").datepicker();
		$("#patientBirthday").keyup(function(e) {
