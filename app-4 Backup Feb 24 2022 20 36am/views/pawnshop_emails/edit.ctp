	...
	<div class="col-lg-6">
		...
		<div class="panel panel-default">
			<div class="panel-heading" id="headerBackgroundColor">
				<h4>Edit Email Details</h4>
			</div>
			<div class="panel-body">
				<div class="table table-responsive">
					<table class="table table-bordered">
					
						<?php echo $this->Form->create('PawnshopEmail', array('action'=>'edit', 'class'=>'form-horizontal')); ?>
						...
						<tr>
							<td>
								<?php echo $this->Form->submit(__('Edit Details',true), array('class'=>'w3-btn w3-teal w3-round-small')); ?>
