							...
							<table class="table w3-striped w3-border" data-count-payment="<?php echo count($transactionDetails['TransactionInterestPayment']); ?>" id="tablePaymentDetails">
									...
									*/
									...
									if(count($transactionDetails['TransactionInterestPayment']) == 0)
									{
										...
										*/
										...
										$this->year 	= floor($diffs / (365*60*60*24));
									    $this->month 	= floor(($diffs - $years * 365*60*60*24) / (31*60*60*24));
									    $this->day 		= floor(($diffs - $years * 365*60*60*24 - $months*31*60*60*24) / (60*60*24));
								...
								?>
									...
									<tr>
										...
										<td class="w3-center">
											<?php echo ($value_interest_details['payment_amount'] + $value_interest_details['other_charge_amount'] + $value_interest_details['service_charge']) - $value_interest_details['less_charge_amount']; ?>
										</td>
										<td class="w3-center">
										...
										<div class="modal-body">
										   <table class="table table-bordered">
												...
												<tr>
													...
													<td>
														<input name="data[TransactionRedeemItem][less_charge_amount]"  class="w3-input w3-border w3-light-grey" id="redeemLessChargeAmount" <?php echo $readOnlyIfRoleIsClerk; ?>>
													</td>
												</tr>
												<tr>
				...
				<div class="modal-body">
					<table class="table table-bordered">
						...
						<tr>
							...
							<td>
								<input name="data[TransactionInterestPayment][less_charge_amount]"  class="w3-input w3-border w3-light-grey" id="lessChargeAmount" <?php echo $readOnlyIfRoleIsClerk; ?>>
							</td>
						</tr>
