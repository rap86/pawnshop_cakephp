...
<div class="row">
	<div class="col-lg-12">
		<h3 style="border-bottom:1px solid #e5e5cc;" class="w3-gray w3-padding w3-border w3-border-gray">
		Under Auction Takeout |
		<a href="/print/print/print_book/1/takeout" target="_blank" class="btn btn-default">Print Book 1</a> | 
		<a href="/print/print/print_book/2/takeout" target="_blank" class="btn btn-default">Print Book 2</a> |
		<a href="/print/print/print_book/3/takeout" target="_blank" class="btn btn-default">Print Book 3</a>
		</h3>
		...
		<div class="tab-content my-tab">
			<div class="tab-pane fade in active" id="book1">
				...
				<table width="100%" class="table table-bordered table-hover" id="dataTablesUsers">
					<?php echo $this->element('takeout_index', array('pawn_book1' => $pawn_book1)); ?>
				</table>
			</div>
			...
			<div class="tab-pane fade" id="book2">
				<br />
				<table width="100%" class="table table-bordered table-hover" id="dataTablesUsers">
					<?php echo $this->element('takeout_index', array('pawn_book1' => $pawn_book2)); ?>
				</table>
			</div>
			...
			<div class="tab-pane fade" id="book3">
				<br />
				<table width="100%" class="table table-bordered table-hover" id="dataTablesUsers">
					<?php echo $this->element('takeout_index', array('pawn_book1' => $pawn_book3)); ?>
				</table>
			</div>
