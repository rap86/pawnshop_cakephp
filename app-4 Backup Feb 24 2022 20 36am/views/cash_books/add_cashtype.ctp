<div class="row">
	<div class="col-lg-6">
		<br />
		<form method="post" action="/cash_books/add_cashtype" class="form-horizontal">
			...
			<div class="panel panel-default">
				<div class="panel-heading" id="headerBackgroundColor">
				 ...
				 <div class="panel-body">
					<table class="table table-bordered">
						<tr>
							<td style="width:30%;">Cash Type</td>
							<td style="width:70%;">
								<select name="data[CashBook][status]" class="w3-input w3-border" style="font-size:30px;">
									<option value=""></option>
						...
						<tr>
							...
							<td style="width:70%;">
								<input name="data[CashBook][amount]" class="w3-input w3-border w3-light-grey" id="amount" style="font-size:30px;" autocomplete="off" required />
							</td>
						</tr>
						<tr>
							<td>Details</td>
			  ...
			  <div class="panel-footer">
				...
				<div class="w3-btn w3-teal w3-block w3-padding-16" id="addWithdrawal">Add Cash type</div>
			  </div>
			</div>	
		</form>
	</div>
