			...
			<div class="panel-body">
				<div class="table table-responsive">
					<table class="table table-bordered">
						...
						<?php echo $this->Form->create('Book', array('action'=>'add', 'class'=>'form-horizontal')); ?>
						...
						<tr>
							<td>
								<?php echo $this->Form->submit(__('Add Information',true), array('class'=>'w3-btn w3-teal w3-round-small')); ?>
